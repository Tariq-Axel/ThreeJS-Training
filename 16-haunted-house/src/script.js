...
camera.position.z = 4
scene.add(camera)
gsap.to(camera.position, {x:0,y:2,z:30,duration: 8, delay:0.5})
gsap.to(camera.position, {x:-3,y:1,z:6,duration: 5, delay:8.5})
...
controls.lookSpeed=0.005/7
controls.movementSpeed=1/40
/**
 * Shadows
 */
